...
**Solução:**
Chame um eletricista profissional. Ele instala com segurança e rapidez. Solicite um orçamento sem compromisso!`,
    date: "2026-06-15",
    category: "Instalação",
  },
  {
...
Sua vida pode depender de um DR funcionando! Verifique o seu hoje!`,
  ...
  },
  {
    ...
    title: "Conta de Luz Muito Alta? Conheça a Solução com LED",
    excerpt: "Descubra como trocar para LED pode reduzir drasticamente seu consumo de energia elétrica.",
    content: `Sua conta de luz está muito alta? Trocar para LED pode economizar energia e reduzir seus gastos mensais. Veja como:
    
**Vantagens do LED:**
- Consome até 80% menos que lâmpadas incandescentes
- Consome até 50% menos que fluorescentes
- Durabilidade muito maior — chegando a 50.000 horas
- Sem mercúrio (mais seguro para o meio ambiente)
- Várias cores e intensidades disponíveis
- Acende instantaneamente

**Benefícios práticos:**
- Menor consumo de energia na conta mensal
- Menos trocas de lâmpada ao longo do tempo
- Melhor qualidade de iluminação
- Mais segurança (não esquenta tanto)

**Como contratar:**
- Chame um eletricista profissional
- Ele indica o LED certo para cada ambiente
- Instala com segurança
- Garante o funcionamento

Comece a economizar energia HOJE! Chame um profissional para avaliar sua iluminação!`,
    date: "2026-06-24",
    category: "Economia",
  },
  {
...
- Investimento que se paga ao longo do tempo
- Aumenta o valor do imóvel
...
**Por que fazer:**
- Evita acidentes
- Reduz necessidade de reparos emergenciais
...
Manutenção preventiva traz segurança e tranquilidade para sua família!`,
    date: "2026-06-16",
    category: "Manutenção",
  },
  {
